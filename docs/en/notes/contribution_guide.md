...
Style configurations can be found in [setup.cfg](https://github.com/vbti-development/onedl-mmediting/blob/1.x/setup.cfg).
...
The config for a pre-commit hook is stored in [.pre-commit-config](https://github.com/vbti-development/onedl-mmediting/blob/1.x/.pre-commit-config.yaml).
